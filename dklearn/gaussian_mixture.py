...
class GPRCluster:
    def __init__(self, train_X, train_y, kernel_obj, log_ls, tau, feature_map=None, group_len=20, out_index=0):
        ...
        self.start_idx = out_index * group_len  # the start index of feature map
        self.end_idx = (out_index + 1) * group_len  # the end index of feature map
    ...
    def predict(self, test_X):
        if self.feature_map is None:
            ...
            test_X_feature = self.feature_map(test_X)[..., self.start_idx:self.end_idx]
            train_X_feature = self.feature_map(self.train_X)[..., self.start_idx:self.end_idx]
