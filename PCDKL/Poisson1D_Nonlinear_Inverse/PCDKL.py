...
def pde_fn(x, u, k):
    ...
    return 0.01 * u_xx + k * torch.tanh(u)
...
if __name__ == '__main__':
    ...
    dataset_filename = os.path.join(base_dir, "PCDKL/Poisson1D_Nonlinear_Inverse/dataset0.01.mat")
    ...
    # f_mean, f_std = model.prediction_f(x_test)

    # compute the RL2E
    # u_RL2E = metrics.RL2E(u_mean, u_test) * 100

    # f_RL2E = metrics.RL2E(f_mean, f_test)
